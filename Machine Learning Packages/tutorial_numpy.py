...
def exSlicing():
    ...
    # Two ways of accessing the data in the middle row of the array. Mixing integer indexing with slices yields an array of lower rank,
...
def exDataType():
    ...
    x = np.array([1, 2], dtype=complex)  # Force a complex datatype
    print(x.dtype)  # Prints "int64"
