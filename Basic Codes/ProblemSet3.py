...
def problem3_3(month, day, year):
    ...
    #pass # replace this pass (a do-nothing) statement with your code
    tup_month = ("Jan", "Feb", "Mar", "Apr", "May","June","July","Aug","Sep","Oct","Nov","Dec")
    print(str(tup_month[month]) + " " + str(day) + ", " + str(year))
...
def problem3_4(mon, day, year):
    ...
    #pass # replace this pass (a do-nothing) statement with your code
    dic_month = {"Jan":1, "Feb":2, "Mar":3, "Apr":4, "May":5,"June":6,"July":7,"Aug":8,"Sep":9,"Oct":10,"Nov":11,"Dec":12}
    print(str(dic_month[mon]) + "/" + str(day) + "/" + str(year))
